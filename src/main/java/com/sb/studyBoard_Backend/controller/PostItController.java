...
public class PostItController {
    ...
    public ResponseEntity<List<PostitDTO>> getAllPostitsByBoardId(@PathVariable Long boardId) {
        try {
            List<PostitDTO> postits = postitService.getAllPostitsByBoardId(boardId);
